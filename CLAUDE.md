...
This project is indexed by GitNexus as **coe** (2248 symbols, 2851 relationships, 14 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
